...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        // content://com.example.shasta.sunshine/weather/94074
        ...
        // content://com.example.shasta.sunshine/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.example.shasta.sunshine/weather/1419120000
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",
                WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.example.shasta.sunshine/location/
